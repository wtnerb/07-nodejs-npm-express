...
// It houses all of the scripts we want to run on the page and runs them.  It runs last according to the .html structure.
...
// on the new.html, whenever we change the state in the new-form element, articleView.create() will create a new article based on the change that was made
